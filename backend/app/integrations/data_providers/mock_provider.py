...
class MockDataProvider(BaseDataProvider):
    ...
    def __init__(self):
        ...
        self._stocks = {
            "RELIANCE": MarketIndex(
                "RELIANCE", "Reliance Industries", 2967.50, 0.02, 10000000
            ),
            ...
            "HINDUNILVR": MarketIndex(
                "HINDUNILVR", "Hindustan Unilever", 2645.80, 0.016, 3000000
            ),
            "ITC": MarketIndex("ITC", "ITC Limited", 458.25, 0.017, 5000000),
            "KOTAKBANK": MarketIndex(
                "KOTAKBANK", "Kotak Mahindra Bank", 1789.60, 0.02, 4000000
            ),
            "SBIN": MarketIndex("SBIN", "State Bank of India", 785.40, 0.022, 10000000),
            "BHARTIARTL": MarketIndex(
                "BHARTIARTL", "Bharti Airtel", 1234.50, 0.025, 6000000
            ),
    ...
    async def get_option_chain(
        ...
        for strike in strikes:
            ...
            call_ltp = (
                intrinsic_call * random.uniform(0.85, 1.15) + 5
                if intrinsic_call > 0
            ...
            put_ltp = (
                intrinsic_put * random.uniform(0.85, 1.15) + 5
                if intrinsic_put > 0
                else random.uniform(1, 10)
            )
            ...
            option_chain.append(
                OptionChainData(
                    ...
                    call_oi=random.randint(
                        max(10000, oi_base), max(50000, oi_base * 2)
                    ),
