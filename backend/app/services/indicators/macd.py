...
def calculate_signal_line(macd_line: List[Optional[float]], period: int = 9) -> List[Optional[float]]:
    """
...
def calculate_macd_histogram_rate(histogram: List[Optional[float]]) -> List[Optional[float]]:
    """
